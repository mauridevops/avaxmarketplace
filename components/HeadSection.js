              ...
              <div className="relative dark:bg-bgcolor overflow-hidden">
               ...
               <div className="relative z-10 pb-8 indigo-900 sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
                   ...
                   <h1 className="text-4xl tracking-tight font-extrabold text-red-600  sm:text-5xl md:text-6xl">
                       ...
                       on the world's first & largest NFT marketplace,this Sixth Sense Course that is will learn more about nfts and solidity programming language   </p>
                       ...
                       <div className="rounded-md shadow">
                           ...
                           <a  className="mt-4 w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-red-600 hover:bg-gray-700 md:py-4 md:text-lg md:px-10">
               ...
               <img className="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="./poster.png" alt="headerSection Image" />
               </div>
               </div>

        ...
        <div className="bg-white shadow-2xl rounded-b-3xl">
          ...
          <div className="grid grid-cols-4 w-72 lg:w-5/6 m-auto bg-indigo-50 mt-5 p-4 lg:p-4 rounded-2xl">
            <div className="col-span-1">
              <img className="w-15 lg:w-12" src="./avx.png" alt="music icon"/>
            </div>
            <div className="col-span-2 pt-1">
              <p className="text-gray-800 font-bold lg:text-sm">Price</p>
              <p className="text-gray-500 text-md">2/AVAX</p>
            </div>
        
          </div>
          <div className="mb-8 bg-gray-800 w-72 lg:w-5/6 m-auto mt-5 p-2 hover:bg-red-600  rounded-2xl  text-white text-center shadow-xl shadow-bg-blue-700">

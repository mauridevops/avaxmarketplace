...
<div className="flex justify-start items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-red-600 " viewBox="0 0 20 20" fill="currentColor">
...
<p className="text-yellow-700 font-bold tracking-wider">Balance : {props.children.balance} AVAX</p>
        </div>
        </div>
        </div>
        </div>

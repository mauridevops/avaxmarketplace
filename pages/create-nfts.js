        ...
        <div className="flex justify-center">
            <div className = "w-1/2 flex flex-col pb-11">
                ...
                />
                 <input
                className = "mt-8 borderd rounded p-3 bg-gray-200"
                placeholder="Enter your NFT Price in AVAX"
                ...
                />
                 ...
                 <div className="grid grid-cols-1 space-y-2 py-4">
                        ...
                        <div className="flex items-center justify-center w-full">
                            ...
                            <button className="font-bold bg-red-600  mt-5 rounded p-4 text-white"  onClick={createMarketItem}>Submit Your NFT</button>

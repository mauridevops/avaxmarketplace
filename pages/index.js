...
//TODO: fix this object
            ...
            return myItem;
              ...
              setUnsoldItems(items)
               ...
               window.alert("You are at Wrong Netweok, Connect with Avalanche Please")
           }
         ...
         <div >
           ...
           <HeadAccount >{{account:account,balance:accountBalance}}</HeadAccount>
           {
             (unsoldItems.length < 5 )?
              <>
              <h1 className=" py-20 text-4xl tracking-tight font-extrabold text-red-600  sm:text-5xl md:text-6xl">
                  <span className="block lg:py-3 xl:inline">There is Lessthan 5 NFts </span>
                  </h1> 
             </>:
             <>
              <h1 className=" px-20 text-xl tracking-tight font-extrabold text-red-600  sm:text-3xl md:text-4xl">
           ...
           <div className = "flex justify-center">
               ...
               <h1 className=" px-10 text-xl tracking-tight font-extrabold text-red-600  sm:text-3xl md:text-4xl">
        ...
        <div className="bg-white shadow-2xl rounded-b-3xl">
          ...
          <div className="grid grid-cols-4 w-72 lg:w-5/6 m-auto bg-indigo-50 mt-5 p-4 lg:p-4 rounded-2xl">
            ...
            <div className="col-span-2 pt-1 ">
              ...
              <p className="text-gray-500 text-sm font-bold">{item.price} AVAX</p>
            </div>
        
          </div>
          <div className="bg-gray-800 w-72 lg:w-5/6 m-auto mt-6 p-2 hover:bg-red-600  rounded-2xl  text-white text-center shadow-xl shadow-bg-blue-700">
